...
module.exports = JSON.parse('{"name":"scrum-timer","version":"1.1.0","license":"MIT","scripts":{"ng":"ng","start":"ng serve --host 0.0.0.0","build":"ng build","test":"ng test","lint":"eslint -c .eslintrc.js --ext .ts src","lint:fix":"eslint -c .eslintrc.js --fix --ext .ts src","e2e":"ng e2e","bump-version":"npm version patch -m \\"Bump version to %s\\" && git push --tags","bump-version-major":"npm version major -m \\"Bump version to %s (Major release)\\" && git push --tags","bump-version-minor":"npm version minor -m \\"Bump version to %s\\" && git push --tags","deploy":"ng build --base-href \\"https://josste.github.io/ScrumTimer/\\" && cp ./dist/index.html ./dist/404.html && angular-cli-ghpages --no-silent"},"private":true,"dependencies":{"@angular/animations":"^15.0.4","@angular/common":"^15.0.4","@angular/compiler":"^15.0.4","@angular/core":"^15.0.4","@angular/forms":"^15.0.4","@angular/platform-browser":"^15.0.4","@angular/platform-browser-dynamic":"^15.0.4","@babel/polyfill":"^7.12.1","bootstrap":"^4.6.1","core-js":"^3.16.2","diff":"^5.0.0","font-awesome":"^4.7.0","jquery":"^3.6.2","npm":"^9.1.1","popper.js":"^1.16.0","rxjs":"^6.6.7","rxjs-compat":"^6.6.7","tether":"^1.4.7","tslib":"^2.3.0","zone.js":"~0.12.0"},"devDependencies":{"@angular-devkit/build-angular":"^15.0.3","@angular-eslint/eslint-plugin":"^12.2.0","@angular/cli":"^15.0.3","@angular/compiler-cli":"^15.0.3","@angular/language-service":"^15.0.3","@angular/router":"^15.0.3","@types/jasmine":"~3.6.0","@types/jasminewd2":"^2.0.8","@types/node":"^13.13.34","@typescript-eslint/eslint-plugin":"^4.28.1","@typescript-eslint/parser":"^4.28.1","angular-cli-ghpages":"^0.6.2","codelyzer":"^6.0.2","eslint":"^7.29.0","jasmine-core":"~3.8.0","jasmine-spec-reporter":"~5.0.0","karma":"~6.3.2","karma-chrome-launcher":"~3.1.0","karma-cli":"~2.0.0","karma-coverage":"^2.0.3","karma-coverage-istanbul-reporter":"~3.0.2","karma-firefox-launcher":"^2.1.1","karma-jasmine":"~4.0.0","karma-jasmine-html-reporter":"^1.7.0","karma-junit-reporter":"^2.0.1","protractor":"^7.0.0","ts-node":"~8.8.2","typescript":"~4.8.4"}}');
