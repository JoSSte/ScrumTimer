...
var TimerComponent = (function () {
    ...
    TimerComponent.prototype.markAbsent = function (participant) {
        if (this.participatingParticipants.length <= 2) {
            ...
            var idx = this.participatingParticipants.indexOf(participant);
